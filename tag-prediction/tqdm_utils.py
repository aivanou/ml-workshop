...
var RegionFinder = (function()
{
    ...
    RegionFinder.prototype = {
        ...
        getURLWithRegion: function() {
            ...
            var isPathname = ifPathnameExists(this.location.search, "pathname");

            var queryArgs = removeURLParameter(this.location.search, "region");

            if(isPathname) {
                queryArgs = removeURLParameter(removeURLParameter(queryArgs, "pathname"), "redirect_host");
            }
            ...
            var pathname = isPathname ?  _getPathnameFromAttributes() : this.location.pathname;
    ...
    function ifPathnameExists(url, parameter) {
    ...
    function _getRedirectHostFromAttributes() {
    	return "us-west-2.console.aws.amazon.com";
    }

    function _getPathnameFromAttributes() {
        return "";
    }
